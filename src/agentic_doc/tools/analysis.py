...
def get_analysis_tools(state, logger, document_assessor, image_enhancer):
    ...
    def assess_document(image_path: str) -> str:
        ...
        If this fails, skip to detect_regions directly (it uses a different image reader)."""
        ...
        try:
            ...
            return json.dumps({
                ...
                "hint": "Do NOT retry — try detect_regions directly instead, "
                        "which uses a different image reader (PIL).",
            })
